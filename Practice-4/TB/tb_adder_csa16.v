module tb_adder_csa;
    ...
    initial begin
        ...
        errors = 0;
        $display("==================================================");
        $display("   Starting CSA Verification...");
        $display("==================================================");

        // --- DIRECTED TESTS (Identical to RCA) ---
        ...
        // --- RANDOMIZED TESTS (Identical parameters) ---
        ...
        // --- FINAL REPORT ---
        $display("\n==================================================");
        if (errors == 0) $display("   SUCCESS! CSA functions perfectly.");
        else             $display("   FAILED! Found %0d errors in CSA.", errors);
        $display("==================================================");
        $finish;
    end
    ...
    task check_results;
        ...
        begin
            ...
            if ({cout, sum} !== expected_result) begin
                $display("ERROR in CSA [%0s]: a=%h, b=%h, cin=%b | Expected=%h, Got=%h", 
